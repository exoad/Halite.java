...
public final class use_Guard
{
   ...
   * instead seek
   */
  public static final impl_DGuard BOOLEAN = Boolean::parseBoolean;
   ...
   */
  public static final impl_DGuard BETTER_BOOL = x -> x.equalsIgnoreCase("false") || x.equalsIgnoreCase("true")
